...
function correctAns() {
  let responseHtml = `<div class = "response"><h2>You chose the correct answer, "${STORE.questions[STORE.questionNumber].answer}"</h2><button type="button" class="button" id="nextButton">Next</button></div>`
...
function incorrectAns() {
  let responseHtml = `<div class = "response"><h2>You chose an incorrect answer. The correct answer is, "${STORE.questions[STORE.questionNumber].answer}"</h2><div><button type="button" class="button" id="nextButton">Next</button></div></div>`
  $(".ans-eval").html(responseHtml)
  displayInfo();
}
